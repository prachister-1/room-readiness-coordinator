...
export const specialistAgents: SpecialistAgent[] = [
  {
    ...
    kind: 'ai',
    purpose: 'Best room and timing from reservation rules, guest needs, availability, room condition, and policy.',
  ...
  },
  {
    ...
    name: 'Task Agent',
    kind: 'auto',
    purpose: 'Creates housekeeping, maintenance, and logistics work with owners, deadlines, and proof.',
  ...
  },
  {
    ...
    kind: 'ai',
    purpose: 'Detects risks and escalations, then recommends recovery without violating hard stops.',
  ...
  },
  {
    ...
    name: 'Trace Agent',
    kind: 'auto',
    purpose: 'Keeps the audit trail and explanation for every observation, recommendation, approval, and verification.',
