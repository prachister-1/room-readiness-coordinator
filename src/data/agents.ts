...
export const specialistAgents: SpecialistAgent[] = [
  ...
  },
  {
    ...
    currentActions: [
      'Kiara Garcia — four traces on 412: clean, feather-free, cot, inspection. Ready blocked until verified.',
  ...
  },
  {
    ...
    example: 'Kiara Garcia notified at 11:43: room verified ready and digital check-in available.',
    cases: ['Kiara Garcia', 'Sofia Garcia', 'Daniel Kim'],
    confidence: 'High · policy-gated',
    awaitingApproval: false,
    lastAction: 'Held Sofia ready-copy until inspection verifies',
    currentActions: [
      'Kiara Garcia — ready message sent 11:43 after Coordinator verification.',
